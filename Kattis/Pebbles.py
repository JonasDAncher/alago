...
def moveRight(gameRight,pos, pebbles):
    if pos > 20 or not gameRight[pos+1] == "o" or not gameRight[pos+2] == "-":
        return 25 # A value higher than the most pebbles possible for comparison
...
def OPT(game,pos,pebbles):
    ...
    if game[pos] == "-": 
        ...
        if game in mem: return mem[game]
        right = moveRight(game, pos, pebbles)
        left = moveLeft(game, pos, pebbles)
        # Below is some of the worst comparison code I've ever seen. Please excuse it. 
        # I'm trying to compare something that can be NoneType, and it's a bitch. 
        # I'm new to python, ok.
